 ...
 */
object OperationUnmarshaller : ImmutableObjectUnmarshaller<OperationUnmarshaller.Ephemeral,Operation>(
    ...
    override fun toFinal(ephemeral: Ephemeral) = Operation(
            DCP = ephemeral.dcp        ?: throw Unmarshaller.Exception.ObjectIncomplete(missingTag = Tag.DCP.string),
            parameters                   = ephemeral.parameters .toList(),
            constraints                  = ephemeral.constraints.toList()
    )
}